...
1. Нажмите ** кнопку&#65291;Создать ресурс** и выполните поиск по запросу *Cognitive Services*. Выберите **Создать** план **Cognitive Services** . Вы перейдете на страницу для создания ресурса служб ИИ Azure. Настройте его с помощью следующих параметров:
