...
Чтобы создать программное обеспечение, которое может интерпретировать слышимую речь и реагировать соответствующим образом, можно использовать службу **"Речь" azure AI** , которая предоставляет простой способ транскрибирования устной речи в текст и наоборот.
...
Службу "Речь" можно использовать, создав ресурс **службы "Речь"** или **ресурс служб ИИ Azure** .
...
1. Дождитесь завершения развертывания. Затем перейдите к ресурсу служб ИИ Azure и на странице **Обзор** щелкните ссылку, чтобы управлять ключами для службы. Для подключения к ресурсу служб ИИ Azure из клиентских приложений потребуется конечная точка и ключи.
