...
1. В созданной учетной записи хранения Azure в области меню слева выберите **Конфигурация** (в разделе **Setetings**).
...
1. В разделе **Сохранение обогащений в хранилище знаний** установите такие флажки:
    ...
    > 1. Щелкните **+ Контейнер** , чтобы создать новый контейнер с именем **knowledge-store** с уровнем конфиденциальности **Частный**, и выберите **Создать**.
