...
- Ресурс **Службы АИ Azure**, который предоставляет службы ИИ для навыков, которые ваше решение для поиска может использовать для обогащения данных в источнике с помощью формируемой ИИ аналитики.
    ...
    > **Примечание** Когнитивный поиск Azure и ресурсы служб ИИ Azure должны находиться в одном расположении!
...
Вам потребуется подготовить ресурс **Службы ИИ Azure**, находящийся в том же расположении, что и ресурс Когнитивного поиска Azure. Решение для поиска будет использовать этот ресурс для обогащения данных в хранилище с помощью генерируемой ИИ аналитики.
...
1. Найдите *учетную запись хранения*, а затем создайте ресурс **Учетная запись хранения**, задав такие параметры:
    - **Подписка**: *ваша подписка Azure*.
    - **Группа ресурсов**: *группа ресурсов, в которой находятся Когнитивный поиск Azure и ресурсы служб ИИ Azure*.
