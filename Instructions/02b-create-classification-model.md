...
1. Найдите модуль **Нормализация данных** и поместите его на холст ниже набора данных **diabetes-data**. Затем подключите область выходных данных из нижней части набора данных **diabetes-data** к области входных данных в верхней части модуля **Нормализация данных** следующим образом:

    ![Снимок экрана: конвейер с набором данных, подключенным к модулю "Нормализация данных".](media/create-classification-model/dataset-normalize.png)
