...
1. На странице **Создание языка** укажите параметры ниже.
    ...
    > **Обратите внимание**, что если вы уже подготовили ресурс бесплатного уровня **Когнитивный поиск Azure**, квота может не позволить вам создать другую. В этом случае выберите уровень, отличающийся от **Бесплатного (F)**.
...
1. В верхней части страницы нажмите кнопку **"Развернуть**". Диалоговое окно спросит, хотите ли вы развернуть проект. Выберите **Развернуть**.
...
1. В портал Azure создайте бот веб-приложения. (Вы можете увидеть предупреждение, чтобы проверка, что источник шаблона является надежным. Вам не нужно предпринимать никаких действий для этого сообщения.) Продолжайте обновление следующих параметров:

    - **Сведения о проекте**
        - **Подписка: *подписка** Azure*
        - **Группа ресурсов**: *группа ресурсов, в которой содержится ваш языковой ресурс*
    - **Сведения об экземпляре**
        - **Расположение** группы ресурсов: *то же расположение, что и* служба языка.
    - **Служба Azure Bot**
        - **Дескриптор** бота: *уникальное имя бота* (*предварительно заполненное*)
    - **Выбор ценовой категории**
        - **Ценовая категория**: бесплатный (F0) (может потребоваться выбрать *план* изменений)
    - **Идентификатор приложения Майкрософт**
        - **Тип** создания: *выбор управляемого удостоверения, назначаемого пользователем* 

5. Нажмите кнопку **Далее: веб-приложение >** , чтобы продолжить обновление параметров. 
    - **Служба приложений**
    ...
    - **Настройки приложения**
        ...
        > **Примечание.** Чтобы перейти к ключу ресурса языка, откройте егоhttps://portal.azure.com[](https://portal.azure.com?azure-portal=true). На домашней странице щелкните *группы* ресурсов и найдите группу ресурсов, в которую вы создали ресурс языка. Выберите ресурс языка и перейдите в меню слева. Затем выберите *ключи и конечную точку*. Скопируйте один из ключей. 

    -  
        - **Имя** проекта языка: MargiesTravel
        - **Имя** узла конечной точки языковой службы: *предварительно заполнено конечной точкой службы языка*
